    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-2 w-1.5 h-1.5 rounded-full" style={{ backgroundColor: '#FF8200' }} />
            </div>
          </button>
        </div>
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:block w-px h-4" style={{ backgroundColor: 'rgba(17,24,32,0.2)' }} />

          <button
            className="flex flex-col justify-between items-center cursor-pointer"
            style={{ width: '52px', height: '14px', background: 'none', border: 'none', padding: 0 }}
          ...
          >
            <span
              ...
              style={{
                ...
                transform: menuOpen ? 'translateY(6px) rotate(45deg)' : menuBarHovered ? 'translateX(0)' : 'translateX(-25%)',
              }}
            />
            <span
              className="block rounded-full"
      ...
      >
        <div className="flex justify-between items-center mb-16">
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#111822" strokeWidth="2">
        ...
        <div className="mt-auto pt-8 border-t" style={{ borderColor: 'rgba(138,143,141,0.2)' }}>
          ...
          <p style={{ color: '#8a8f8d', fontSize: '0.85rem', fontFamily: 'Inter, sans-serif', marginTop: '0.5rem' }}>
            © 2026 Chirag Deol
          </p>
        </div>
      </div>
