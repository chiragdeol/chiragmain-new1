...
export default function Footer() {
  ...
  return (
    <footer
      ref={sectionRef}
      className="mdx-footer"
      style={{ padding: '8rem 5rem 3rem' }}
    >
      {/* Top: Big text */}
      <div className="max-w-7xl mx-auto">
        ...
        {/* Nav + Social */}
        <div
          className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16 reveal"
        >
        ...
        {/* Bottom */}
        <div
          className="flex flex-col md:flex-row md:items-center justify-between gap-4 reveal"
        >
          {/* Logo */}
