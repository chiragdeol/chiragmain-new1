        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="reveal">
            ...
            >
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#8a8f8d" strokeWidth="1.5">
              ...
              {[
                ...
                <div key={item} className="flex items-center gap-3">
                  <div
                    ...
                    style={{ background: 'rgba(255,130,0,0.1)', border: '1px solid rgba(255,130,0,0.2)' }}
                  >
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#FF8200" strokeWidth="3">
            ...
            <div className="flex items-center gap-3 mt-10">
              <a
                ...
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(138,143,141,0.3)';
                  ...
                  <div className="flex flex-wrap gap-2">
                    {serviceOptions.map((service) => (
                      <button
                        ...
                        style={{
                          background: selectedServices.includes(service) ? '#111822' : 'transparent',
                          borderColor: selectedServices.includes(service) ? '#111822' : 'rgba(138,143,141,0.4)',
