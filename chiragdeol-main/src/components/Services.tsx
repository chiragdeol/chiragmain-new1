            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: activeService === i ? 'rgba(255,130,0,0.1)' : 'rgba(138,143,141,0.08)',
                    ...
                    {service.tags.map((tag) => (
                      <span
                        ...
                        style={{
                          ...
                          border: `1px solid ${activeService === i ? 'rgba(255,130,0,0.3)' : 'rgba(138,143,141,0.25)'}`,
                          borderRadius: '2rem',
                          transition: 'all 0.3s ease-out',
                ...
                <div
                  ...
                  style={{
                    border: `1px solid ${activeService === i ? 'rgba(255,130,0,0.4)' : 'rgba(138,143,141,0.3)'}`,
                    transition: 'all 0.3s ease-out',
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke={activeService === i ? '#FF8200' : '#8a8f8d'}
                    strokeWidth="2"
